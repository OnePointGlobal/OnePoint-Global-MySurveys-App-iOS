...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
  ...
  <xsl:template name="SignatureControl">
    ...
    <xsl:element name="input">
      <!--- Set Control Type -->
      <xsl:attribute name="data-role">ocr</xsl:attribute>
      <!--- Input name -->
      <xsl:attribute name="name">
        <xsl:value-of select="@QuestionName"/>
        <xsl:if test="Category[1]/@Name">
  ...
  <xsl:template name="NumberMaskedControl">
    <!--- Control Label -->
    <xsl:if test="Category[1]/Label">
      <xsl:choose>
        <xsl:when test="$bIncludeElementIds">
  ...
  <xsl:template name="CurrencyControl">
    <!--- Control Label -->
    <xsl:if test="Category[1]/Label">
      <xsl:choose>
        <xsl:when test="$bIncludeElementIds">
    ...
    <xsl:element name="input">
      <!--- Set Control Type -->
      <xsl:attribute name="type">currencyinput</xsl:attribute>
      <!--- Input name -->
      <xsl:attribute name="name">
        <xsl:value-of select="@QuestionName"/>
        <xsl:if test="Category[1]/@Name">
